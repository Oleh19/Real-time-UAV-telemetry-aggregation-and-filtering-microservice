...
func run(logger *slog.Logger) error {
	...
	httpServer := &http.Server{
		Addr:              cfg.HTTPAddr,
		Handler:           observabilityHandler(ingestor, natsConn),
...
func observabilityHandler(ingestor *usecase.Ingestor, natsConn *nats.Conn) http.Handler {
